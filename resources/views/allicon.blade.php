<svg xmlns="http://www.w3.org/2000/svg" style="display:none;">
    ...
    {{-- Белая стрелка новости --}}
    <symbol id="white_arrow" viewBox="0 0 24 20" fill="none">
        <path d="M14 0L12.57 1.393L20.15 9H0V11H20.15L12.57 18.573L14 20L24 10L14 0Z" fill="white"/>
    </symbol>

    {{-- Стрелка слайдера --}}
    <symbol id="slider_arrow" viewBox="0 0 38 38" fill="none">
        <circle cx="19" cy="19" r="19" fill="white"/>
        <path d="M19.4167 15L18.7613 15.6269L22.2354 19.05H13V19.95H22.2354L18.7613 23.3579L19.4167 24L24 19.5L19.4167 15Z" fill="black" stroke="black"/>
    </symbol>
